...
public class VodkaItem extends Item {
	public VodkaItem() {
		super(new Item.Properties().tab(CreativeModeTab.TAB_FOOD).durability(25).rarity(Rarity.RARE).food((new FoodProperties.Builder()).nutrition(-5).saturationMod(0f).alwaysEat()
